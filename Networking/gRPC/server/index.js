...
const PROTO_FILE = "./customers.proto";

const packageDefinations =  protLoader.loadSync(PROTO_FILE,{
    keepCase:true, 
    longs:String,
    enums:String,
    arrays:true
...
const customersProto = grpc.loadPackageDefinition(packageDefinations);
